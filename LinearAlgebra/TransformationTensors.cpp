...
namespace LinearAlgebra {
    ...
    Array<double> translationOneTensor(double translationOne) {
    ...
    Array<double> translationTwoTensor(double translationTwo) {
    ...
    Array<double> translationThreeTensor(double translationThree) {
    ...
    Array<double> scalingOneTensor(double scalingOne) {
    ...
    Array<double> scalingTwoTensor(double scalingTwo) {
        Array<double> scalingTensor(3, 3);
    ...
    Array<double> scalingThreeTensor(double scalingThree) {
        Array<double> scalingTensor(3, 3);
        scalingTensor.populateElement(0, 0, 1);
        scalingTensor.populateElement(1, 1, 1);
    ...
    Array<double> rotationTensorOne(double angleInDegrees) {
    ...
    Array<double> rotationTensorTwo(double angleInDegrees) {
        auto angleInRadians = Utility::Calculators::DegreesToRadians(angleInDegrees);
    ...
    Array<double> rotationTensorThree(double angleInDegrees) {
        auto angleInRadians = Utility::Calculators::DegreesToRadians(angleInDegrees);
    ...
    Array<double> shearTensorOne_planeOneTwo(double shearAngleInDegrees) {
    ...
    Array<double> shearTensorTwo_planeOneTwo(double shearAngleInDegrees) {
        auto shearAngleInRadians = Utility::Calculators::DegreesToRadians(shearAngleInDegrees);
    ...
    Array<double> shearTensorOne_planeOneThree(double shearAngleInDegrees) {
        auto shearAngleInRadians = Utility::Calculators::DegreesToRadians(shearAngleInDegrees);
    ...
    Array<double> shearTensorThree_planeOneThree(double shearAngleInDegrees) {
        auto shearAngleInRadians = Utility::Calculators::DegreesToRadians(shearAngleInDegrees);
    ...
    Array<double> shearTensorTwo_planeTwoThree(double shearAngleInDegrees) {
        auto shearAngleInRadians = Utility::Calculators::DegreesToRadians(shearAngleInDegrees);
    ...
    Array<double> shearTensorThree_planeTwoThree(double shearAngleInDegrees) {
        auto shearAngleInRadians = Utility::Calculators::DegreesToRadians(shearAngleInDegrees);
    ...
    Array<double> ReflectionTensorOne_planeOneTwo() {
    ...
    Array<double> ReflectionTensorTwo_planeOneTwo() {
    ...
    Array<double> ReflectionTensorOne_planeOneThree() {
    ...
    Array<double> ReflectionTensorThree_planeOneThree() {
    ...
    Array<double> ReflectionTensorTwo_planeTwoThree() {
    ...
    Array<double> ReflectionTensorThree_planeTwoThree() {
